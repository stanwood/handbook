...
- [People operations](#people-operations)
  ...
  * [Onboarding](#onboarding)
    ...
    + [14. MyTaxi](#14-mytaxi)
    + [15. Trello](#15-trello)
    + [16. TODO: Setup Jira + Toggle Sync:](#16-todo--setup-jira---toggle-sync-)
...
- Ensure:
    ...
    - sync everything discussed in Slack back to Jira

### 3. Internal communication

Keep Hannes and all devs up to the date of milestones, next milestones, of the pressing issues, blockers and goals 3x per week.

Update on Friday till 15:00.

### 4. Fill backlog

Every Friday: Grab the client and fill the backlog of the team according to the project planning spreadsheet for that month.
...
We try to minimise the accounting overhead of travelling as much as possible.

### Booking process

All travels are organised in Trello.

1. When we need a trip, we create a card in "Planning".
2. We add the location, attendees, dates and required actions in a checklist and assign who is responsible for it.
3. As soon as everything is booked, Office manager moves the card to "Booked."

Then add your flight times to the holiday calendar with "{my name} {flight number}", for the organisers see your flight times.
